...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x = ll.toArray(x);
        hello = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,ll);
    ...
    protected void onActivityResult(int requestCode,int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK) {
            ...
            if(requestCode == 0) {
                ...
                ll.add(hi.index(ll,data.getStringExtra(Intent.EXTRA_CC)),data.getStringExtra(Intent.EXTRA_TEXT) + " Due: "+ data.getStringExtra(Intent.EXTRA_CC));
            ...
            if(requestCode == 1) {
                if (data.getStringExtra(Intent.EXTRA_CC).equals("Del")) {
                   ...
                   hello.notifyDataSetChanged();
                    ...
                    hello.remove(data.getStringExtra(Intent.EXTRA_INDEX));
                    hello.notifyDataSetChanged();
                    String [] hi8 = data.getStringExtra(Intent.EXTRA_TEXT).toString().split(" ");
                    ll.add(hi.index(ll,hi8[hi8.length - 1]),data.getStringExtra(Intent.EXTRA_TEXT));
                    hello.notifyDataSetChanged();
                }
            }
        }
